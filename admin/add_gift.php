...
<head>
    ...
    <title>Add Gift | ICHI CATCHER Admin</title>
                                ...
                                <form action="Insert" method="post" enctype="multipart/form-data">
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="" name="gift_name" required>
                                        </div>
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="gift_image" accept="image/png, image/jpeg, image/jpg" required="">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-primary w-50" name="add_gift">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
